...
public class QuizTaker {
    ...
    public QuizTaker(Scanner scanner) {
    ...
    private int handleMCQ(MultipleChoiceQuestion mcq) {
        ...
        if (mcq.evaluate(answer)) {
            ...
            System.out.println("Incorrect. The correct answer was: " + (mcq.getCorrectOptionIndex() + 1));
            return 0;
        }
    }
    ...
    private void displayResults(int earnedPoints, int totalPoints) {
        System.out.println("\n===== Quiz Complete =====");
        System.out.println("Your score: " + earnedPoints + " out of " + totalPoints);
